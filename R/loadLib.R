   ...
   if( .Platform$pkgType != "source" ) {
      ...
      switch( .Platform$pkgType,
         ...
         mac.binary = cat( sep="\n",
            ...
            " | at the following URL:",
            " | http://www.ebi.ac.uk/~anders/gtkr/GTK+_2.14.X11_with_gtkmm.dmg",
            " | Double click onto the downloaded file, then onto the package icon",
            " | that appears and follow the displayed instruction.",
            " | Then, restart R and tray again to load this package.",
            "" ),
